                ...
                <div class="col-sm-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <?php echo form_open_multipart("home/update/$record->id", array('class'=>"form-horizontal", 'enctype'=>'multipart/form-data')); ?>
                            <div class="form-group">
                                <label class="col-lg-2 control-label">Title</label>
                                <div class="col-lg-10">
                                    <input type="text" value="<?php echo $record->title; ?>" placeholder="News Title" name="title" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="file" style="width: 20%;" name="image" value="<?php echo $record->image; ?>" class="form-control" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="date" value="<?php echo $record->date; ?>" class="form-control" name="date" />
