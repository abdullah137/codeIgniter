...
<script type="text/javascript" src="<?php echo base_url('user_resources/js/jquery.js');?>"></script>
<!-- Bootstrap jQuery -->
<script type="text/javascript" src="<?php echo base_url('user_resources/js/bootstrap.min.js');?>"></script>
<!-- Owl Carousel -->
<script type="text/javascript" src="<?php echo base_url('user_resources/js/owl.carousel.min.js');?>"></script>
<!-- Counter -->
<script type="text/javascript" src="<?php echo base_url('user_resources/js/jquery.counterup.min.js');?>"></script>
<!-- Waypoints -->
<script type="text/javascript" src="<?php echo base_url('user_resources/js/waypoints.min.js');?>"></script>
<!-- Color box -->
<script type="text/javascript" src="<?php echo base_url('user_resources/js/jquery.colorbox.js');?>"></script>
<!-- Smoothscroll -->
<script type="text/javascript" src="<?php echo base_url('user_resources/js/smoothscroll.js');?>"></script>
<!-- Isotope -->
<script type="text/javascript" src="<?php echo base_url('user_resources/js/isotope.js');?>"></script>
<script type="text/javascript" src="<?php echo base_url('user_resources/js/ini.isotope.js');?>"></script>

<!-- Template custom -->
<script type="text/javascript" src="<?php echo base_url('user_resources/js/custom.js');?>"></script>

</div><!-- Body inner end -->
</body>

<!-- Mirrored from themewinter.com/html/news247/single-post1.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Aug 2017 00:07:09 GMT -->
</html>