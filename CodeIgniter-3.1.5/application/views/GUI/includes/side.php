<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
    <div class="sidebar sidebar-right">
        ...
        $query = $this->db->query("SELECT * FROM news WHERE news.file_type = 'image' ORDER BY date DESC LIMIT 1");
        $row = $query->row();
        ...
        <?php endforeach; ?>
            ...
            <div class="list-post-block">
                <ul class="list-post">
                    <?php
                    $category = $record->category;
                    $query = $this->db->query("SELECT * FROM news WHERE file_type = 'image' ORDER BY date DESC LIMIT 1, 3");
                    $row = $query->row();
                    foreach ($query->result_array() as $row):
                    $image = $row['image'];
                    $id = $row['id'];
