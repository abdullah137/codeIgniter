			...
			<div class="row">
				...
				<div class="error-page text-center">
					...
					<div class="error-body">
						...
						<?php echo anchor("user_index", 'Back to Home Page', array('class'=>'btn btn-primary')); ?>
					</div>
				</div>
...
<!-- Mirrored from themewinter.com/html/news247/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Aug 2017 00:07:16 GMT -->
</html>